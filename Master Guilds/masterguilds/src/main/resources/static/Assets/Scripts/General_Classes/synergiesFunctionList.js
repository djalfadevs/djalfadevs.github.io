...
var synergyFunction1 = function(input){
   ...
   for(var i=0;i<input.team.length;i++){
    ...
    input.advantages.push({ID:"1_"+lvl,name:"attack",level:lvl}) 
}
...
var synergyFunction2 = function(input){
    ...
    input.advantages.push({ID:"2_"+lvl,name:"defence",level:lvl}) 
}
...
var synergyFunction3 = function(input){
    ...
    input.advantages.push({ID:"3_"+lvl,name:"critical hit chance",level:lvl}) 
}