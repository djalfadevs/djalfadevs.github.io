...
class mainMenu extends Phaser.Scene{
	...
	create(){
        ...
        this.add.text(1250,505,'Collection',{fontFamily:"Museo-700" ,fontSize:'69px',color:'#000',fontStyle:'bold'})
        this.add.text(1350,805,'Shop',{fontFamily:"Museo-700" ,fontSize:'69px',color:'#000',fontStyle:'bold'})
